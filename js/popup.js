...
function restore() {
    chrome.storage.sync.get([
        ...
        'replaceTime'
            ...
            document.getElementById("replaceTime").value = data.replaceTime;
        });
}
...
document.getElementById("replaceTime").addEventListener("focusout", save);
